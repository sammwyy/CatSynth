...
export interface ISequencerEventData {
...
/** @internal */
export function rewriteEventDataImpl(
  ev: PointerType,
  ...
  switch (event.type) {
    ...
    case "programselect":
    case "program-select":
      _module._fluid_event_program_select(
        ev,
        event.channel,
        event.sfontId,
        event.bank,
    ...
    case "controlchange":
    case "control-change":
      _module._fluid_event_control_change(
        ev,
        event.channel,
        event.control,
        event.value
    ...
    case "key-pressure":
    case "aftertouch":
      _module._fluid_event_key_pressure(
        ev,
        event.channel,
        event.key,
        event.value
 ...
 */
export function rewriteEventData(
  data: ISequencerEventData,
  event: SequencerEvent
): boolean {
