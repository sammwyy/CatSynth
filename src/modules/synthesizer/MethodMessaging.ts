...
/** @internal */
export type HookReturnMessageCallback = (
  data: MethodReturnEventData
) => boolean;
...
export function initializeCallPort(
  ...
  port.addEventListener("message", (e) =>
    processReturnMessage(instance.defers, hookMessage, e)
  );
  port.start();
  return instance;
}
...
function convertAnyErrorTransferable(err: any): MessageErrorData {
  return convertErrorTransferable(
...
function processReturnMessage(
  defers: DeferMap,
  hook: HookReturnMessageCallback | undefined,
  e: MessageEvent
) {
...
/** @internal */
export function postCallWithPromise<T>(
  instance: CallMessageInstance,
  method: string,
  args: any[]
): Promise<T> {
  ...
  if (!target[data.method]) {
    ...
    try {
      postReturnImpl(
        ...
        data.id,
        data.method,
        target[data.method].apply(target, data.args)
      );
    } catch (e) {
...
export function postReturn(
  instance: ReturnMessageInstance,
  id: number,
  method: string,
  value: any
) {
...
/** @internal */
export function postReturnError(
  instance: ReturnMessageInstance,
  id: number,
  method: string,
  error: any
